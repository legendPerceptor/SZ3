...
int main(int argc, char * argv[])
{
    ...
    if(argc < 3)
    {
		printf("Test case: test_zfp_fixratio [srcFilePath] [tolerance] [dimension sizes...]\n");
		printf("Example: test_zfp_fixratio test.f32 10 8 8 128\n");
		exit(0);
    }
    ...
    size_t outSize = 0; 
    cost_start();
    unsigned char* bytes = zfp_compression(data, ZFP_FLOAT, ZFP_FXR, tolerance, r5, r4, r3, r2, r1, &outSize);
    cost_end();
    ...
    cost_start();
    float* decData = zfp_decompression(ZFP_FLOAT, ZFP_FXR, bytes, compressedDataSize, r5, r4, r3, r2, r1);
    cost_end();

...
//    }
    ...
    template<class T>
    class MultipleErrorBoundsQuantizer : public PredictionBasedQuantizer<T> {
    public:
        MultipleErrorBoundsQuantizer(T eb, int r = 32768) : PredictionBasedQuantizer<T>(eb, r) {
        }
...
//    }
    ...
    template<class T>
    inline int MultipleErrorBoundsQuantizer<T>::quantize_and_overwrite(T &data, T pred) {
